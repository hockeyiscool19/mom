...
case "$1" in
  ...
  -p) docker push  $AWS_ACCOUNT_NUM.dkr.ecr.us-east-1.amazonaws.com/mom-texter:tag && docker tag my-ecs:latest $AWS_ACCOUNT_NUM.dkr.ecr.us-east-1.amazonaws.com/mom-texter:tag ;;
